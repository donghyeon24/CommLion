...
urlpatterns = [
    ...
    path('notice/', views.noticeMain, name='noticeMain'),
    path('notice/write/', views.noticeWrite, name='noticeWrite'),
    path('session/<int:session_num>/', views.sessionMain, name='sessionMain'),
    ...
    path('qna/detail/<int:session_num>/', views.qnaDetail, name='qnaDetail'),
